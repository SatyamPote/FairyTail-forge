...
export default function Home() {
  ...
  return (
    <div className="flex h-screen bg-slate-950 text-slate-50 overflow-hidden font-sans">
          ...
          <div className="flex items-center gap-4">
            {currentProject && (
              <div className="flex items-center gap-2">
                <span className="px-2 py-0.5 bg-indigo-600 rounded text-[10px] font-bold uppercase tracking-wider">
                  Project
                </span>
      ...
      {/* Modals */}
      <StoryGeneratorModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </div>
  );
}
